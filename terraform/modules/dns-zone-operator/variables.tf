...
variable "region_ou_path" {
  description = "AWS Organizations OU path for the region's MC accounts (e.g. o-abc123/r-abc1/ou-abc1-abc12345/*). Used in trust policy to allow any MC in the OU to assume this role."
  type        = string
