...
export TF_VAR_enable_sns_alert_bridge=$(parseBool '.enable_sns_alert_bridge' false "$DEPLOY_CONFIG_FILE")
...
echo "  Enable SNS Alert Bridge: $TF_VAR_enable_sns_alert_bridge"
