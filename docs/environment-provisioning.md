...
> **Note:** The DNS zone operator requires the SSM parameter `/infra/region-ou-path` in the RC account (the AWS Organizations OU path for MC accounts). This is currently created manually and will be automated via account-minter.
